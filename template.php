...
<head>
  ...
  <?php $this->load->view("$folder_themes/commons/meta_header.php"); ?>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-4">
            <div class="row" id="judul" data-aos="zoom-in">
              <h4>Musyawarah Penerimaan BLT DD Tahun 2021</h4>
            </div>
            <div class="small text-mutted mb-2" id="text-mutted" data-aos="zoom-out">
              <i class="bi bi-calendar-check-fill"></i> 29 Juli 2013
              <i class="bi bi-person-fill"></i> Administrator
              <i class="bi bi-eye-fill"></i> 29 Kali dibaca
              <i class="bi bi-chat-right-dots-fill"></i> 10
              <i class="bi bi-tags-fill"></i>
              <a class="badge bg-secondary text-decoration-none link-light" href="#!">Web Design</a>
            </div>
            <img src="assets/img/article/article-1.jpg" class="img-thumbnail" width="600" alt="" data-aos="zoom-in" data-aos-delay="150">
            <p data-aos="fade-up">
              ...
              <ul>
                <li>
                  <a data-bs-toggle="collapse" class="collapse" data-bs-target="#accordion-list-1"><span>01</span> Non
                    consectetur a erat nam at lectus urna duis? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                ...
                <li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-2" class="collapsed"><span>02</span>
                    Feugiat scelerisque varius morbi enim nunc? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                ...
                <li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-3" class="collapsed"><span>03</span>
                    Dolor sit amet consectetur adipiscing elit? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
              ...
              <div class="member-info">
                <h4>Disman</h4>
                <span>Kasi Kesra dan Pemberdayaan</span>
                <p>Aut maiores voluptates amet et quis praesentium qui senda para</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
